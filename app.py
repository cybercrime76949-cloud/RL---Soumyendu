...
if __name__ == '__main__':
    ...
    print("   Upload Project: http://localhost:5000/upload-project")
    print("   Projects Gallery: http://localhost:5000/projects-gallery\n")
    
    # Network access
    print("📱 FROM MOBILE/OTHER DEVICES (Same WiFi):")
    print("   Home: http://192.168.0.5:5000")
    print("   Upload Project: http://192.168.0.5:5000/upload-project")
    print("   Projects Gallery: http://192.168.0.5:5000/projects-gallery\n")
